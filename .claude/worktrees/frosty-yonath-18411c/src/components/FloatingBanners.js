  ...
  return (
    <>
      ...
      <div className={`float-banner float-social${socialHidden ? ' hidden' : ''}`}>
        ...
        <a href="https://wa.link/yd0l5p" target="_blank" rel="noopener noreferrer" className="social-icon whatsapp" title="WhatsApp" aria-label="WhatsApp">
        ...
        <a href="mailto:support@goolkai.com" className="social-icon email" title="Email · support@goolkai.com" aria-label="Email">
